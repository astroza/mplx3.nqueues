...
int mplx3_listen(mplx3_settings *, const char *, unsigned short, ev_call1, void *);
...
void mplx3_init(mplx3_settings *, alloc_func, free_func, unsigned int, unsigned int);
void mplx3_launch(mplx3_settings *);
